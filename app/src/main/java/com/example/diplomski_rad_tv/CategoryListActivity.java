...
public class CategoryListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO: update variables from estates collection
    ...
    void setupMain() {
        ...
        } else if (this.categoriesToShow.size() == 0 /*&& !this.loadingInProgress*/) {
            ...
            switch (this.language) {
                case english:
                    if (this.theme == Theme.dark) {
                        ...
                        this.setTitleText(View.VISIBLE, R.string.category_name_en, R.color.text_color_light_mode);
                ...
                case german:
                    if (this.theme == Theme.dark) {
                        ...
                        this.setTitleText(View.VISIBLE, R.string.category_name_de, R.color.text_color_light_mode);
                ...
                case croatian:
                    if (this.theme == Theme.dark) {
                        ...
                        this.setTitleText(View.VISIBLE, R.string.category_name_hr, R.color.text_color_light_mode);
                        this.setCenterText(View.VISIBLE, R.string.no_categories_hr, R.color.text_color_light_mode);
                    }
                    break;
            }
        ...
        } else if (this.overallIndex < this.categoriesToShow.size()) {
            this.hideProgressBar();

            this.setCenterText(View.INVISIBLE, R.string.empty_string, R.color.transparent);
            if (this.theme == Theme.dark) this.setTitleText(View.VISIBLE, this.categories[this.categoriesToShow.get(this.overallIndex)].title, R.color.text_color_dark_mode);
            else if (this.theme == Theme.light) this.setTitleText(View.VISIBLE, this.categories[this.categoriesToShow.get(this.overallIndex)].title, R.color.text_color_light_mode);
    ...
    void setupPaginationButton() {
        ...
        if (this.categoriesToShow.size() != 0) paginationCurrentPage.setText(Integer.toString(this.currentPage + 1));
    ...
    void setupCategoriesToShow() {
        ...
        for (int i = 0; i < categories.length; ++i) {
            if ((categories[i].title.toLowerCase()).contains(this.searchbarText.toLowerCase())) this.categoriesToShow.add(i);
        }
    }
    ...
    void setGridButton(View[] views, int drawableId, int viewIndex) {
        ...
        int visibility = viewIndex >= this.categoriesToShow.size() ? View.INVISIBLE: View.VISIBLE;
        String titleText = viewIndex < this.categoriesToShow.size() ? this.categories[this.categoriesToShow.get(viewIndex)].title : "";
    ...
    void setGridButtonImage(ImageButton imageButton, int viewIndex) {
        if (viewIndex < this.categoriesToShow.size() && this.categories[this.categoriesToShow.get(viewIndex)].image != null && !this.categories[this.categoriesToShow.get(viewIndex)].image.isEmpty()) {
            try {
                Picasso.get()
                        .load(this.categories[this.categoriesToShow.get(viewIndex)].image)
                        .fit()
                        .into(imageButton);
            } catch (Exception e) {
                e.printStackTrace();
    ...
    void setGridButtonImage(ImageView imageButton) {
        if (this.categories[this.categoriesToShow.get(this.overallIndex)].image != null && !this.categories[this.categoriesToShow.get(this.overallIndex)].image.isEmpty()) {
            try {
                Picasso.get()
                        .load(this.categories[this.categoriesToShow.get(this.overallIndex)].image)
                        .fit()
                        .into(imageButton);
            } catch (Exception e) {
                e.printStackTrace();
    ...
    void navigateToElementListActivity() {
        String categoryId = this.categories[this.categoriesToShow.get(this.overallIndex)].id;
        ...
        Intent i = new Intent(getApplicationContext(), ElementListActivity.class);
        startActivity(i);
    }
}
